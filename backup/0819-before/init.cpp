...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += "  -peersslcertificatechainfile=<file.cert>  " + _("Server certificate file (default: server.cert)") + "\n";
    strUsage += "  -peersslprivatekeyfile=<file.pem>         " + _("Server private key (default: server.pem)") + "\n";
